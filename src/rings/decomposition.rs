...
/// fields), endowed with certain information that is necessary to perform certain operations
/// efficiently.
...
///    property that it allows computing multiplications component-wise, but note that it
...
/// 
/// Two [`DecomposableNumberRing`]s that are considered equal as given by [`PartialEq`] should
